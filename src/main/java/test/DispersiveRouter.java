...
public abstract class DispersiveRouter<H, P> {
    ...
    private final List<PeerAndHash<P>> peersAndHashes;
    ...
    public DispersiveRouter(P[] providedPeers) {
        ...
        this.peersAndHashes = new ArrayList<PeerAndHash<P>>(providedPeers.length);
    ...
    public String toString() {
        return String.valueOf(this.getPeers());
    }
